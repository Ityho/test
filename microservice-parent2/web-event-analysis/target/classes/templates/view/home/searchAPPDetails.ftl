        ...
        <div class="wui-content rel" id="app">
            ...
            <input id="isApp" name="isApp" value="${isApp}" style="display: none">
            <input id="isSensitive" name="isSensitive" value="${isSensitive}" style="display: none">
            <!--body-->

            <#if isSensitive == 1>
                <div class="show-msg">
                    <img  src="${staticResourcePathH5}/images/group.png?v=${SYSTEM_INIT_TIME}">
                    <p style="font-size: 14px; color: white">  对不起，您的关键词包含敏感词语，请检查后再试！</p>
                </div>
            <#else>
        ...
        <script src="${staticResourcePathH5}/js/newHome/jquery-1.10.2.min.js"></script>
        ...
        <script>
            ...
            function loadMoreTwo(){
                app.loadMore(2);
            }

            function doAndroidUnseal(){
                doUnseal();
            }
