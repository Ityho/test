angular.module('ngApp', []).controller('initController',function($scope,$http){
	var prompt = "<br> <div align='center' style='padding-top:50px'><p style='display:inline;font-size: 14px'><img src='"+njxBasePath+"/images/shouye/warn.png' style='width:60px'><br/>¥À ±º‰∂Œ‘›Œﬁ–≈œ¢</p></div>";
