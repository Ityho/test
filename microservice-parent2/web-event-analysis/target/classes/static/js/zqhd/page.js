...
function winORlose() {
	...
	setTimeout(function() {
		...
		if (eat_count <= 20) {
			chat = "才吃了"+ eat_count + "个月饼，继续加油哦！！";
			share = "我在微舆情中秋吃月饼大赛中吃掉了" + eat_count + "个月饼，打败了5%的人，求填饱";
			share_imgUrl = "../images/zqhd/c4.png";
			$("#c20").css("background","url('../images/zqhd/c38.png')");
		} else {
			if (eat_count <= 35) {
				chat = "吃了" + eat_count + "个月饼，还可以更厉害呢！";
				share = "我在微舆情中秋吃月饼大赛中吃掉了" + eat_count + "个月饼，打败了15%的人，求填饱";
				share_imgUrl = "../images/zqhd/c4.png";
				$("#c20").css("background","url('../images/zqhd/c37.png')");
			} else {
				$("#c20").css("background","url('../images/zqhd/c20.png')");
				if (eat_count <= 50) {
					chat = "胃口不错，一口气吃" + eat_count + "个，吃完月饼记得再喝点小酒";
					share = "我在微舆情中秋吃月饼大赛中吃掉了" + eat_count + "个月饼，打败了25%的人，求填饱";
					share_imgUrl = "../images/zqhd/c4.png"
				} else {
					if (eat_count <= 65) {
						chat = "万万没有想到！你吃了" + eat_count + "个月饼！放开吃，吃完哥请你喝酒！";
						share = "我在微舆情中秋吃月饼大赛中吃掉了" + eat_count + "个月饼，打败了35%的人，求填饱";
						share_imgUrl = "../images/zqhd/c4.png"
					} else {
						if (eat_count <= 80) {
							chat = "你吃了" + eat_count + "个月饼，看样子你根本停不下来，加油，再来一次更牛的！！";
							share = "我在微舆情中秋吃月饼大赛中吃掉了" + eat_count + "个月饼，打败了45%的人，求填饱";
							share_imgUrl = "../images/zqhd/c4.png"
						} else {
							if (eat_count <= 95) {
								chat = "你吃了" + eat_count + "个月饼，这样的速度，标准的一吃货啊，有潜质 ！";
								share = "我在微舆情中秋吃月饼大赛中吃掉了" + eat_count + "个月饼，打败了55%的人，求填饱";
								share_imgUrl = "../images/zqhd/c4.png"
							} else {
								if (eat_count <= 110) {
									chat = "你吃了" + eat_count + "个月饼，我看你天赋异禀、骨骼惊奇，想来是百年难得一见的吃货奇才！";
									share = "我在微舆情中秋吃月饼大赛中吃掉了" + eat_count + "个月饼，打败了65%的人，求填饱";
									share_imgUrl = "../images/zqhd/c4.png"
								} else {
									if (eat_count <= 125) {
										chat = "我勒个去，你吃了" + eat_count + "个月饼…说点什么好？记得吃药…。";
										share = "我在微舆情中秋吃月饼大赛中吃掉了" + eat_count + "个月饼，打败了75%的人，求填饱";
										share_imgUrl = "../images/zqhd/c4.png"
									} else {
										if (eat_count <= 140) {
											chat = "你吃了" + eat_count + "个月饼，这么快的速度，够神啊";
											share = "我在微舆情中秋吃月饼大赛中吃掉了" + eat_count + "个月饼，打败了85%的人，求填饱";
											share_imgUrl = "../images/zqhd/c4.png"
										} else {
											chat = "天啊，你竟然吃了" + eat_count + "个月饼，简直是神一般的存在，膜拜啦！";
											share = "我在微舆情中秋吃月饼大赛中吃掉了" + eat_count + "个月饼，打败了95%的人，神一般的存在！";
											share_imgUrl = "../images/zqhd/c4.png"
										}
									}
								}
...
$(document).on("click touchstart", "#c18", function(a) {
	a.preventDefault();
	a.stopPropagation();
	window.location.href="goMooncakeShare.shtml";
});
...
$(function() {});
var shareUrl = "http://h5.gzlankong.com/games/yuebing/",
	shareTitle = "中秋吃月饼大赛，求超越！",
	share = "中秋吃月饼大赛，求超越！",
	share_imgUrl = "http://h5.gzlankong.com/games/yuebing/images/c4.png";
