...
public class ShortUrlGenerator {
	public static void main(String[] args) {
		...
		String sLongUrl = "http://h1.wyq.cn/view/eventAnalysis1/analysisPreview.action?tickets=中国" ; // 3BD768E58042156E54626860E241E999
		String[] aResult = shortUrls (sLongUrl);
		// 打印出结果
