...
public class FileUpload {
	...
	public static void main(String[] args) throws IOException {
		String filePath = "e:/weixinCallback.jpg";
		String sendUrl = "https://api.weixin.qq.com/cgi-bin/media/upload?access_token="+AccessTokenUtil.getSubscriptionNumberAccessToken().getAccess_token()+"&type=image";
		String result = null;
