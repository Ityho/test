package com.miduchina.wrd.eventanalysis.weibo4j.authorize;

import com.miduchina.wrd.eventanalysis.config.WeiboConfig;
import com.miduchina.wrd.eventanalysis.weibo4j.*;
...
public class Oauth extends Weibo {
	...
	public String authorize(String response_type) throws WeiboException {
		String sd=WeiboConfig.getValue("authorizeURL").trim() + "?client_id="
...
//	public JsapiTicket getJsapiTicketByCode() throws WeiboException {
//		return new JsapiTicket(client.post(WeiboConfig.getValue("jsTicketURL"),
//				new PostParameter[] {
//						new PostParameter("client_id", WeiboConfig
//								.getValue("AppKey")),
//						new PostParameter("client_secret", WeiboConfig
//								.getValue("AppSecret")) }, false, null));
//	}
}
