angular.module('ngApp', []).controller('initController',function($scope,$http,httpSerive,utils){
	var prompt = "<br> <div align='center' style='padding-top:50px'><p style='display:inline;font-size: 14px;color:   #C0C0C0;'><img src='"+njxBasePath+"/images/shouye/warn.png' style='width:60px'><br/>此时间段暂无信息</p></div>";
	var prompt2 = "<br> <div align='center' style='padding-top:20px;padding-bottom: 20px;'><p style='display:inline;font-size: 14px;color:   #C0C0C0;'><img src='"+njxBasePath+"/images/shouye/warn.png' style='width:60px'><br/>此时间段暂无信息</p></div>";
	...
	bigpipe.ready('doMediaFriend',function(result){
		if(result.status){
			...
			opt.series[0].data[0] = (result.obj[0].percent / 100).toFixed(4);
