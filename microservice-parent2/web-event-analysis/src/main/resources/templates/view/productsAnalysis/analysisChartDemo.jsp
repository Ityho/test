...
<script src="<%=staticResourcePathH5 %>/js/productsAnalysis/zzsc.js?v=<%=SYSTEM_INIT_TIME %>"></script><!--浮动栏JS-->
  ...
  /*  $("#time-group>li").on("click",function(){
    ...
    if(sign==1){
       ...
       //goLineChartHeatNetwork();//网络热度
        ...
        /* params.fileName = 'negativeWord';//负面高频词汇
		negativeHighFrequency(params); */
		if(idd>0){
    		//旧的
				...
				return;
					...
					if(listData==null){
						...
						/* for(var i=0;i<listData.legend.length;i++){
							var subMsg = listData.datetime[0]+"针对"+listData.legend[i]+"的报道最多，达到了<font class='f_c2'>"+listData.data[i].data[0]+"</font>条；";
							alertMsg += subMsg;
						} */
				...
				var listData = eval(res[0].data);
					if(listData==null||listData[0]==null){
						...
						for(var i=0;i<data.length;i++){
                            ...
                            msg_6+='"'+data[i].groupValue+'"在全国8大重要媒体的提及量为<font class="f_c2">'+sumCount+'</font>条;';
    						ulHtml += "</ul></td></tr>";		   
    						trHtml += ulHtml;	
    						divHtml += trHtml;
						}
                        ...
                        msg_6+='"'+data[maxIndexMeadia].groupValue+'"的传播力显然更好。';
...
//                                 alertMsg += '"' + nameArr[j] + '"';
           ...
           var alertMsg1=alertMsg.substr(alertMsg.length-1,1);
            ...
            alertMsg+='。';
            //alertMsg+='就整个敏感走势对比来看，互联网对"'+listData[maxIndexNegative].name+'"的敏感报道更多，需进一步分析。';
        ...
        if (data==null||data==""){
            ...
            for(var i=0;i<data.length;i++){
               ...
               if(i==2||i==4){
                ...
                /*if(data[i].length>0){
                    alertMsg+='"'+name+'"的负面高频词汇主要以"'+data[i][0].name +'、'+data[i][1].name+'、'+data[i][2].name+'"为主;';
                }*/
                   /*  if(f>0) {
                        alertMsg += '"' + name + '"的负面高频词汇主要以"' + data[i][f - f].name;
                    }
                    if(f>1){
        ...
        if (data==null||data==""){
            ...
            if(data[0].data==null || data[0].data.length==0){
                ...
                for(var i=0;i<data.data.length;i++){
                    ...
                    /*topTime = new Date(topTime).format("yyyy-MM-dd hh时");*/
                    topTime = topTime.split(":")[0];
...
<!-- header start -->
	...
	<s:if test = 'isApp!=1'>
		 <section class="section" style="border-left:solid 6px #fd8c25;">
            ...
            <div style="margin-top: 12px;margin-right:20px;" class="float_r"><a href="<%=njxBasePath %>/productsReport.shtml" class="">返回</a></div>
        </section>
	</s:if>
<!-- header end -->
...
<div class="content">
	             ...
	             <div style="width:100%;height:65px;">
	                 <div class="info" style="background-color:#FFF;">
			               	...
			               	<div class="float_l">
			               		...
			               		<span style="margin-left:10px;">微热点</span>
			               	...
			               	<span id="starttime_show"><fmt:formatDate value="${pab.startTime}" pattern="yyyy-MM-dd"/></span>到<span id="endtime_show"><fmt:formatDate value="${pab.endTime}" pattern="yyyy-MM-dd"/></span>
			               	</div>
	             			<div class="clear"></div>
	         			</div>
	             	</div>
	...
	<div class="row-fluid">
       	...
       	<div class="wrapCon">
       		<div class="tit">
    		<h2>传播走势分析对比</h2><%-- <span class="small">从${starttime}到${endtime}</span> --%>
    	    </div>
    	    <div class="row-fluid">
...
<!-- 												<label class="btn btn-sm active">宝马</label> -->
<!-- 												<label class="btn btn-sm">奔驰</label> -->
<!-- 												<label class="btn btn-sm">福特</label> -->
						   </div>
				  		</div>
     ...
     <%--   	<div class="wrapCon">
       		<div class="tit">
    		<h2>人群定位</h2><span class="small">从2016-01-20到2016-01-27</span>
    	    </div>  
    	    <div class="row-fluid">
       	...
       	<s:if test = 'isApp!=1'>
	        <div class="fenxiang phone_hide float_r" >
	            ...
	            <!-- <a href="#" class="jiathis_button_weixin icon icon_wx" title="微信"></a> -->
	            <%-- <a href="#" class="icon icon_pyq" title="朋友圈"></a>--%>
  ...
  <%--  <div class="row-fluid">
        ...
        <div class="bottomText">
            <p><a href="http://wyq.sina.com">更多精彩，尽在“微热点”</a></p>
            <p>手机上打开微博客户端扫描二维码</p>
            <!--<p>长按二维码识别下载客户端</p>-->
	...
	<s:if test = 'isApp!=1'>
	    ...
	    <%-- 
	        <div class="fenxiang2">
	            <a class="jiathis_button_tsina icon icon_wb" target="_blank" title="微博"></a>
	            <!-- <a href="javascript:;" onclick="" class="jiathis_button_weixin icon icon_wx" title="微信"></a> -->
	            <a href="javascript:;" onclick="" class="icon icon_pyq" title="朋友圈"></a>
	            <a class="jiathis_button_cqq icon icon_qq" target="_blank" title="QQ"></a>
	            <a class="jiathis_button_qzone icon icon_qqkj" target="_blank" title="QQ空间"></a>
	        </div>--%>
...
$(function(){
	...
	/* $(".jiathis_button_weixin").on("click",function(){
		jiathis_config.title = "呀~这很可能是最完成的对手分析情报";
		jiathis_config.summary = "多维度呈现，快戳";
	}); */
