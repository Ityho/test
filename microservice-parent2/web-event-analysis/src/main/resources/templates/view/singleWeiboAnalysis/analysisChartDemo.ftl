...
<!-- header end -->
<div class="page-container2" <s:if test = "#attr.isApp == 1">style = 'margin-top:0px;'</s:if>>
<!--订阅中心 start-->
<div class="content">
	<div class="row-fluid">
		<div class="tit tit3" style="width: 100%; overflow: hidden;">
			<h1>${title}的对比分析</h1>
			<div class="actions">
				<!-- <a class="button button" href="javascript:void(0);" onclick="javascript:exportReport();">导出</a> -->
...
<script>
	...
	function goSubscribe(){
		if("${admin}"){
			...
			location.href = actionBase+"/user/login";
		}
	}
</script>
<#include "../../buttom.ftl" >
