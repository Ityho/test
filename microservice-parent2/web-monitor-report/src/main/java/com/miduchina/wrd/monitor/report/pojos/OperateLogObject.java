...
public class OperateLogObject {
	...
	private Integer product; // 产品：1-微舆情
	private Object user; // 用户ID
	private String reqTime; // 访问时间
	private String reqIp; // 访问IP
	private Integer productChannel; // 产品入口：1-WEB 2-APP 3-H5 4-微博WEB
	...
	private String reqReferer; // 请求referer信息
	private String mobilePlatform; // 客户端平台：ios、android
	private String mobileVersion; // 客户端版本
	private String logExtraInfo; // 扩展信息
	private Integer channelTag;//渠道 1. 邮件，2. 短信，3. PUSH-安卓，4. PUSH-小米，5. PUSH-华为，6. PUSH-IOS，7. WEIBO私信，8.WEB弹窗，9.WEIXIN，10.QQ，11.WEIBO（内容）
}
