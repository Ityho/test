...
public class DataSourceConfig {
	@Bean(name = "ranklistDS")
	@Qualifier("ranklistDS")
	@Primary
	@ConfigurationProperties(prefix = "spring.datasource.ranklist")
	public DataSource masterDataSource() {
		return DataSourceBuilder.create().type(com.alibaba.druid.pool.DruidDataSource.class).build();
	}

	@Bean(name = "mediaselDS")
	@Qualifier("mediaselDS")
	@ConfigurationProperties(prefix = "spring.datasource.mediasel")
	public DataSource mediaselDataSource() {
		return DataSourceBuilder.create().type(com.alibaba.druid.pool.DruidDataSource.class).build();
	}
	@Bean(name = "routerDS")
	@Qualifier("routerDS")
	public MasterSlaveDataSourceRouter masterSlaveDataSourceRouter() {
		...
		targetDataSources.put(MasterSlaveDataSourceHolder.RANKLIST, masterDataSource());
		targetDataSources.put(MasterSlaveDataSourceHolder.MEDIASEL, mediaselDataSource());
