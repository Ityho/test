    ...
    <!--  <div class="mail_heard">
     ...
     <section class="section" style="cursor: pointer;">
         <div class="mail_Banner rel">
         	 <a onclick = "http://www.wrd.cn" style="display: block;height: 100%;width: 20%;position: absolute;top: 0px;left:0px;"></a>
             <div class="picBg"></div>
             <div><a onclick="jumpLogin()" style="color:#fff;">修改监测方案，让预警更精准~
                 去修改 ></a></div>
         </div>
     </section>
     <!--banner代码 end-->
