 ...
 * @version: V1.0
 */
package com.miduchina.wrd.api.casebase.service.impl;

import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.miduchina.wrd.api.casebase.mapper.CaseBaseMapper;
...
public class CaseBaseServiceImpl implements CaseBaseService {
	...
	@Override
	public List<Double> selectHotEventsIntervalChart(Map<String, Object> param) {
		List<Double> result=caseBaseMapper.selectHotEventsIntervalChart(param);
		return result;
	}

	@Override
	public List<WyqCase> select30HotWorths(Map<String, Object> param) {
		List<WyqCase> result=  caseBaseMapper.select30HotWorths(param);
		return result;
	}

	@Override
	public WyqCase checkCaseAnalysis(Integer caseID) {
		WyqCase result = caseBaseMapper.checkCaseAnalysis(caseID);
		return result;
	}
}
