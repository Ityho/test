 ...
 * @version: V1.0   
 */
package com.miduchina.wrd.api.casebase.config;
...
public class Swagger2 {
	...
	public Docket createRestApi() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
				.apis(RequestHandlerSelectors.basePackage("com.miduchina.wrd.api.casebase.controller")).paths(PathSelectors.any()).build();
	}
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("案例库 RESTful APIs").description("案例库api接口文档").version("1.0").build();
	}
