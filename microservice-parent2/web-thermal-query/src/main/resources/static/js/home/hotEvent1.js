...
let vm = new Vue({
    ...
    mounted: function () {
        ...
        bodymovin.loadAnimation({
            path: 'css/indexV4/global/vendor/lottie/loading.json',   //json文件路径
            loop: true,
            autoplay: true,
    ...
    methods: {
        ...
        allProvince: function () {
            ...
            this.$http.post(actionBase + '/view/home/hotEvent/allProvince.action', {
                ...
                if (this.allProvinceData != null) {
                    for (let i = 0; i < this.allProvinceData.length; i++) {
                        let x = {
                            name: "",
                            value: [{name: "", value: 0}],
                            incidentTitle: "",
        ...
        request: function () {
            //发送 post 请求
            this.$http.post(actionBase + '/view/home/hotEvent/goHotEvent.action', {}, {emulateJSON: true}).then(function (res) {
