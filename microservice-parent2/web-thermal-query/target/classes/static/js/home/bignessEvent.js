...
var activeTab2 = new Vue({
	...
	methods:{
		...
		getLabelList: function (id) {
			$.post(actionBase + '/view/home/hotEvent/getHotClassList.action',function (result) {
		...
		getBignessEventList:function(){
			...
			$.post(basePath+'/view/home/bignessEvent/getBignessEventList.action',searchObj,function(result){
				if(result.code == "0000"){
