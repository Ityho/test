/*微舆情基于jquery的扩展模块，整合项目中常用的基础js效果*/
...
//panel full全屏缩放
var full = 1;
$(" .panel .panel-heading").find(".tools a.full").on("click", function() {
	if(full) {
		full--;
...
//panel collapse隐藏/展开内容
   $('.panel-collapse').on('show.bs.collapse', function () {
         $(this).parents(".panel").find(".tools a.collapse i").addClass("icon-angle-down").removeClass("icon-angle-up").attr("data-original-title","收起");
    })
     $('.panel-collapse').on('hide.bs.collapse', function () {
         $(this).parents(".panel").find(".tools a.collapse i").addClass("icon-angle-up").removeClass("icon-angle-down").attr("data-original-title","展开");
  })
