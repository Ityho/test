...
//                      +'点]'+this.title+'[ '+this.captureWebsiteName+' ] 相同文章数：'+this.repeatNum
            //+'</textarea><div class="rel"><div class="tool tooledit" style="position: initial;"><button href="#" class="button button4">'
            //+'<i class="icon-dele"></i>删除</button></div></div></div></div></li>';
            li += "<p style='font-size: 12px;' class='msfs'><span class='float_l'><span><font class='f_c1'>阅读</font>&nbsp;"+this.views+"<span style='margin-left: 20px;color: #b7b7b7;'>|</span>";
            li += "</span><span style='margin-left: 20px;'><font class='f_c1'>转发</font>&nbsp;"+this.forwardNumber+"<span style='margin-left: 20px;color: #b7b7b7;'>|</span>";
            li += "</span><span style='margin-left: 20px;'><font  class='f_c1'>评论</font>&nbsp;"+this.comments+"<span style='margin-left: 20px;color: #b7b7b7;'>|</span>"+"</span><span style='margin-left: 20px;'><font  class='f_c1'>点赞</font>&nbsp;"+this.praiseNum+"</span></span></p>";
            li +='</a></div></div></li>';
        ...
        if(data==null ||data.length==0|| data[0].data==null || data[0].data.length==0){
            ...
            if (charType == 1) {
                ...
                for (var i = 0; i < label.length; i++) {
                    ...
                    if(label[i].name=='男性'){
            			html += "<div class='gender2 male'><i class='icon-gender-male'></i><strong id='comments_male-fans-scale'>"+sexValue+"%</strong>男性</div>";
            		}else if(label[i].name=='女性'){
            			html += "<div class='gender2 female'><i class='icon-gender-female'></i><strong id='comments_male-fans-scale'>"+sexValue+"%</strong>女性</div>";
            		}else{
            			html += "<div class='gender2 other'><i class='icon-gender-other'></i><strong id='comments_male-fans-scale'>"+sexValue+"%</strong>其它</div>";
            		}
                }
...
function BloggerTop10CallBack(data){
    if (data==null||data==""){
        ...
        for(var i=0;i<topLength;i++){
            ...
            if(province == null || province == "")	//兼容老数据
...
function hotPeopleCallBack(data){
    if(data==null||data==''){
        ...
        for(var i=0;i<data.length;i++){
            ...
            liHtml += "<div class='abs' style='bottom: 10px;width: 93%;padding-top: 10px;left: 10px;right: 10px;margin: auto;border-top: 1px solid #e2e2e2;'><p style='margin-left: 20px;margin-bottom: 5;' class='msfs'><span class=''><span class='inline-block' style='width: 40%;display: inline-block;margin-left: 40px;'><font class='f_c1'>阅读</font>&nbsp;"+data[i].views;
            liHtml += "</span><span style='width: 38%;display: inline-block;margin-right: 0;'><font class='f_c1'>转发</font>&nbsp;"+data[i].forwardNumber;
            liHtml += "</span></span></p><p style='margin-left: 20px;margin-bottom: 5;' class='msfs'><span class=''><span class='inline-block' style='width:40%;display: inline-block;margin-left: 40px;'><font  class='f_c1'>评论</font>&nbsp;"+data[i].comments+"</span><span style='width: 38%;display: inline-block;margin-right: 0;'><font  class='f_c1'>点赞</font>&nbsp;"+data[i].praiseNum+"</span></span></p></div></li>";
            ulHtml += liHtml;
...
function emoteAnalysisCallback(data){
    if(data!=null&&data!=''){
        ...
        forwardCallBack(data[2],data[3],'container7_3', data[5]);	//转发表情分析
