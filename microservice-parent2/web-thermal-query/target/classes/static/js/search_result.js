...
function goView(title,id,titleHs,province,customFlag1,repeatNum,involveKeyword){
	...
	var params = {'con.id':id, 'titleHs':titleHs, 'start_time':starttime, 'end_time':endtime, 'otherAttribute':otherAttribute,
        'filterOrigina':filterOrigina, 'province':province, 'searchKeyword':searchKeyword, 'secondSearchWord':secondSearchWord,
        'searchPipeiType':searchPipeiType, 'con.customFlag1':customFlag1, 'con.repeatNum':repeatNum,'solrType':solrType,
        'timeDomain':timeDomain,'newlstSelect':newlstSelect,'involveKeyword':involveKeyword};
