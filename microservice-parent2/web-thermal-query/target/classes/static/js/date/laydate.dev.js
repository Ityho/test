...
Dates.use = function(lib, id){
    ...
    link.type = 'text/css';
    link.rel = 'stylesheet';
    link.href = staticResourcePath+"/js/date/need/"+as[5];
    id && (link.id = id);
...
//皮肤选择
laydate.skin = function(lib){http://cdn.files-beta.51wyq.cn/web/js/date/skins/default/laydate.css
    Dates.skinLink.href = staticResourcePath + "/js/date/" + as[4] + lib + as[5];
};
