...
<link rel="stylesheet" href="${staticResourcePath}/css/accordion.css?v=${sysConfig}"/>
<link rel="stylesheet" href="${staticResourcePath}/css/animate.min.css?v=${sysConfig}">
<link rel="stylesheet" href="${staticResourcePath}/css/anina.css?v=${sysConfig}">
<link rel="stylesheet" href="${staticResourcePath}/css/indexV4/base/css/less/w-site.css">
<script src='${staticResourcePath}/js/prettify.js?v=${sysConfig}'></script>
<script src='${staticResourcePath}/js/jquery-ui-1.9.1.custom.js?v=${sysConfig}'></script>
<script src='${staticResourcePath}/js/jquery.slimscroll.js?v=${sysConfig}'></script>
<script src='${staticResourcePath}/js/jquery.tabs.js?v=${sysConfig}'></script>
<script src="${staticResourcePath}/js/bootstrap.min.js?v=${sysConfig}"></script>
<script src='${staticResourcePath}/js/taskMessage.js?v=${sysConfig}' charset="GBK"></script>
<script src='${staticResourcePath}/js/city.js?v=${sysConfig}' charset="UTF-8"></script>
<link rel="stylesheet" href="${staticResourcePath}/css/css/bootstrap-select.css?v=${sysConfig}"/>
<#--var request=${request};-->
...
<#if admin1 ??>
    <script>
        ...
        var baseAction = '${njxBasePath }';
        function logout(){
            window.location.href="${staticResourcePath}/identiy/login/logout";
        }
        $(function() {
        ...
        $(function(){
            ...
            if(urll.indexOf("firstLoginSign")>=0){
                ...
                $('.spiritBox').show();
                $.ajax({
                    url : '${staticResourcePath}/view/usercenterV2/findGiftCardByUserId.action',
                    type : 'POST',
                    success : function(data) {
                        if(data.code=="0000"){
                ...
                success : function(result) {
                    if (!$.isEmptyObject(result)) {
                        if (result.code == '0000') {
                            ...
                            var now = new Date();
                            var sf=$("#admin").val();
                            // var sf1=sf.proUserValidEndTime;
                            var proValidEndDate = new Date(sf);
    ...
    <!-- 新版购买 -->
    <!-- 所有登录弹框start -->
    <link rel="stylesheet" type="text/css" href="${staticResourcePath}/css/notice.css?v=<%=SystemConfig.SYSTEMINITTIME %>"/>
    <a href="javascript:" style="display: none;" id="showNoticeModalBtn" data-toggle="modal" data-target="#noticeModal"></a>
    <div v-if="firstLoginSign == 4">
        <!-- 后台赠送兑换券start -->
        <script src="${staticResourcePath}/js/iscroll.js?v=<%=SystemConfig.SYSTEMINITTIME %>"></script>
        <div v-if ="activitySendRecordList != null && activitySendRecordList.size() > 0">
            <div id="noticeModal" class="setModal fade redPacket" role="dialog" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none; width: 1044px; height: 768px;">
                ...
                <div class="modal-con">
                                    ...
                                    <s:if test='#item.coupon.couponType !=1 &&#item.coupon.couponType !=2&&#item.coupon.couponType !=103&&#item.coupon.couponType !=104&&#item.coupon.couponType !=105&&#item.coupon.couponType !=106&&#item.coupon.couponType !=107&&#item.coupon.couponType !=108&&#item.coupon.couponType !=109&&#item.coupon.couponType !=110&&#item.coupon.couponType !=111&&#item.coupon.couponType !=112'>
                                        <li>
                                            <div onclick="clickHrefBlank('/myCoupons.shtml?operateType=2');" style="cursor: pointer;" class="redPacket-item">
                                                <a  style="text-decoration:none;">
										<span>
											<#--<img src="${staticResourcePath}/images/shouye/icon-prize${item.coupon.couponType }.png"/>-->
										</span>
                                                    <div class="redPacket-des">
                                                        <#--<p class="fz18 fw600">${item.coupon.couponName }</p>-->
                    ...
                    <div class="redPacket-footer">
                        <img src="${staticResourcePath}/css/images/model-foot.png" />
                    </div>
                </div>
        </div>
        <div class="clear"></div>
    ...
    <div v-else="firstLoginSign == 3">
        <script src="${staticResourcePath}/js/iscroll.js"></script>
        <!-- 活动弹框start -->
        <div id="noticeModal" class="actSign fade" role="dialog" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none; width: 768px; left: 0;right: 0;margin: auto;">
            ...
            <div class="modal-body icheckbox-list" style="overflow-y:initial;">
                <div class="modal-con">
                    ...
                    <a href="${staticResourcePath}/usercenter/account.shtml" target="_Blank" class="btn-receive" style="padding-left: 20px;">马上领福利<i class="jiantou"></i></a>
                </div>
            </div>
            <div class="clear"></div>
        </div>
    ...
    <div v-elseif="firstLoginSign == 6">
        ...
        <link href="${staticResourcePath}/css/hotSearch/recharge.css?v=<%=SystemConfig.SYSTEMINITTIME %>" rel="stylesheet" type="text/css">
        ...
        <div id="endModal" class="modal fade base-modal endModal" role="dialog" tabindex="-1" aria-labelledby="endModal" aria-hidden="true" style="display: none; width: 580px; height: 521px;background: transparent;border-top: 0px;box-shadow: none;">
            ...
            <div class="" style="position: relative;">
                <div class="">
                    <!-- 				<a href=""> -->
                    <img onclick="goEndActive();" src="${staticResourcePath}/images/shouye/modal_end.png" style="width: 100%;cursor: pointer;"/>
                    <!-- 				</a> -->
                </div>
    ...
    <!-- 礼品卡弹框 -->
    <div v-elseif="firstLoginSign == 0 || firstLoginSign == 5">
        <style type="text/css">
            .giftCard.modal {
        ...
        <script>
            function goGiftCard(){
                var href = "${staticResourcePath}/giftCard.shtml";
                window.open(href,"_blank");
            }
        </script>

    </div>
    <link href="${staticResourcePath}/css/hotSearch/modal.css?v=<%=SystemConfig.SYSTEMINITTIME %>" rel="stylesheet" type="text/css">
    ...
    <div type="hidden" class="remind  animated fadeInUpBig" id="isGetActive2" style="display: none;">
        <div>
            ...
            <div class="remind-body">
                ...
                <div class="remind-rg">
                    <img src="${staticResourcePath}/images/newuser/modal-pic.png"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <#--<div>-->
        ...
        <#--<div class="remind-body">-->
            ...
            <#--</div>-->
            <#--<div class="remind-rg">-->
                <#--<img src="${staticResourcePath}/images/modal-pic.png"/>-->
            <#--</div>-->
        <#--</div>-->
    <#--</div>-->
<#--</div>-->
    ...
    <!-- 新用户领取方案弹框start -->
    <#if admin.isGiftPackage??&&admin.isGiftPackage==0>
        <script src='${staticResourcePath}/js/divselect.js?v=<%=SystemConfig.SYSTEMINITTIME %>' type="text/javascript"></script>
        <style type="text/css">
    ...
    <form name="buyForm" method="post" action="${staticResourcePath}/pay/confirm.shtml">
    ...
    <div
        <#if isShowTop == '1'>
            class="w-head abs w-headHover min-layout1200"
        <#else >
                class="w-head min-layout1200"
        </#if>
                id="weiyi_head_shouye">
        <div class="w-headbar-top">
            <div class="w-headbar-logo">
                <#--<%--<img src="${staticResourcePath}/images/shouye/w-sm-logo.png" alt="">--%>-->
                <img src="${staticResourcePath}/css/indexV4/base/images/w-md-logo.png" alt="">
            </div>
            ...
            <div class="w-headbar-r">
                <div class="w-heabar-menu">
                    ...
                    <div class="w-heabar-menu-item <#if currentPage=="productsBuy" >active</#if>">
                    <a href="<%=njxBasePath%>/pay/buy.shtml">产品选购</a>
                    </div>
                    <div class="w-heabar-menu-item <#if currentPage=="novice">active</#if>">
                        <a href="<%=njxBasePath%>/novice.shtml">新手专区</a>
                    </div>
                    <div class="w-heabar-menu-item <#if currentPage=="bill">active</#if>">
                        <a href="<%=njxBasePath%>/bill/order.shtml">索取发票</a>
                    </div>
                    <div class="w-heabar-user rel">
                    <a href="${staticResourcePath}/usercenter/account.shtml">
                        <#if admin.userHead ??>
                    ...
                    <div class="UserPrompt abs showObject" style="display: none;">
                        <div>
                            ...
                            <dl class="dl_list rel" id="dl_list0" style="display: none;">
                                ...
                                <#if admin.noUseKeywordCount??>
                                    <dd>监测方案<font class="fc_red" v-hsow="${(admin.noUseKeywordCount >0)?c }"> X ${admin.noUseKeywordCount }</font></dd>
                                </#if>
                                <#if admin.userAnalysisValidCount??>
                                    <dd>全网事件分析<font class="fc_red" v-show="${(admin.userAnalysisValidCount >0)?c}"> X ${admin.userAnalysisValidCount }</font></dd>
                                </#if>
                                <#if admin.userWeiboAnalysisValidCount??>
                                    <dd>微博事件分析<font class="fc_red" v-show="${(admin.userWeiboAnalysisValidCount > 0)?c}"> X ${admin.userWeiboAnalysisValidCount }</font></dd>
                                </#if>
                                <#if admin.userBriefValidCount??>
                                    <dd>简报制作<font class="fc_red" v-show="${(admin.userBriefValidCount > 0)?c}"> X ${admin.userBriefValidCount }</font></dd>
                                </#if>
                                <#if admin.userProductAnalysisValidCount??>
                                    <dd>竞品分析<font class="fc_red" v-show="${(admin.userProductAnalysisValidCount > 0)?c}"> X ${admin.userProductAnalysisValidCount }</font></dd>
                                </#if>
                                <#if admin.userSingleWeiboAnalysisValidCount?? >
                                    <dd>微博传播效果分析<font class="fc_red" v-show="${(admin.userSingleWeiboAnalysisValidCount > 0)?c}"> X ${admin.userSingleWeiboAnalysisValidCount }</font></dd>
                                </#if>
                                <#if admin.exportDataCount??>
                                    <dd>导出数据<font class="fc_red" v-show="${(admin.exportDataCount > 0)?c}"> X ${admin.exportDataCount }</font></dd>
                                </#if>
                            </dl>
                        </div>
                    </div>
        ...
        <div class="w-headbar-bottom">
            <div class="w-headbar-nav">
                <ul class="w-headbar-list clearfix">
                    <li <#if currentPage=="hot">class="active"</#if>>
                    <a href="<%=njxBasePath%>/home.shtml">热点发现</a>
                    </li>
                    <li <#if currentPage=="caseAnalysis">class="active"</#if>>
                    <a href="<%=njxBasePath%>/caseAnalysis.shtml">案例库</a>
                    </li>
                    <li  <#if currentPage=="bigDataRead">class="active"</#if>>
                    <a href="<%=njxBasePath%>/infoData.shtml">大数据报告</a>
                    </li>
                    <li <#if currentPage=="jiance">class="active"</#if> <#if currentPage=="brief">class="active"</#if>>
                    <#if admin.stopFlag??>
                        <a data-toggle="modal" data-target="#stopUserModal" href="<%=njxBasePath%>/keyword.shtml">信息监测</a>
                    <#elseif admin?? && admin.isGiftPackage==0??>
                ...
                <#--<%--</li>--%>-->
                <li class="j_hover
					<#if currentPage=="analysisWb">active</#if> <#if currentPage=="analysis">active</#if>
                <#if currentPage=="productsAnalysis">active</#if>
                <#if currentPage=="reviewAnalysis">active</#if>
                <#if currentPage=="singleWeiboAnalysis">active</#if>
                <#if currentPage=="emotionMap">active</#if>
                <#if currentPage=="search">active</#if>
                ">
                ...
                <div class="w-headbar-dropdown">
                    <div class="w-dropdown-inner active" style="left: -85px;">
                        <ul>
                            <li>
                                <a href="${staticResourcePath}/view/weiboEventAnalysis/taskList.shtml">微博事件分析</a>
                            </li>
                            <li>
                                <a href="${staticResourcePath}/view/eventAnalysis/taskList.shtml">全网事件分析</a>
                            </li>
                            <li>
                                <a href="${staticResourcePath}/productsAnalysis.shtml">竞品分析</a>
                            </li>
                            <li>
                                <a href="${staticResourcePath}/view/reviewAnalysis/reviewIndex.shtml">评论分析</a>
                            </li>
                            <li>
                                <a href="${staticResourcePath}/i/singleWeiboAnalysis/index.shtml">微博传播分析</a>
                            </li>
                            <li>
                                <a href="${staticResourcePath}/emotionMap.shtml">微博情绪</a>
                            </li>
                            <li>
                                <a href="${staticResourcePath}/splitWords.shtml">文本挖掘</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<#else>
    <link rel="stylesheet" type="text/css" href="${staticResourcePath}/css/reginReadPage.css">
    <script src='${staticResourcePath}/js/MD5.js' type="text/javascript"></script>
    <script src='${staticResourcePath}/js/login.js' type="text/javascript"></script>
    <link href="${staticResourcePath}/css/newRegin/loginStyle.css" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="${staticResourcePath}/js/twitter-bootstrap-hover-dropdown.js"></script>
    <!--头部导航start-->
    <div id="MainTool"></div>
    <div class="w-head headHover min-layout1200" id="noLoginCssId">
        <div class="w-headbar-top">
            ...
            <img src="${staticResourcePath}/images/shouye/w-logo-title.png" class="w-headbar-txt margin-left-20" alt="">
            <#--<%--<div class="w-headbar-r">--%>-->
        ...
        <div class="modal-body icheckbox-list text-center clearfix" style="overflow-y:initial;">
            <div class="modal-left pading20" style="min-height: 560px;">
                ...
                <div class="leftIcon pading-bottom-20">
                    <img src="${staticResourcePath}/images/newuser/login-left-pic1.png" />
                </div>
                <div class="title">
                                    ...
                                    <div class="tab-pane fade in active" id="accountLogin">
                                        ...
                                        <div class="login">
                                            ...
                                            <div class="phoneLogin">
                                                ...
                                                <div class="mt20 text-center fc_dark_grey"><a href="${staticResourcePath}/lostPassword.shtml" class="fc_orange-b ml10"> 忘记密码</a></div>
                                            ...
                                            <div class="loginBtn mt10">
                                                ...
                                                <div class="text-center">
                                                    <a href="#" onclick="location.href='${staticResourcePath}/thirdParty/toSinaWeiboLogin.action';" id="wbLoginBtn" class="btn-circle btn-icon50 btn-icon" title="微博登录" style="margin-right: 16px;">
                                                        <i class="icon">&#xe724;</i>
                                                    </a>
                                                    <a href="#" onclick="location.href='${staticResourcePath}/thirdParty/toWeixinLogin.action';" id="wxLoginBtn" class="btn-circle btn-icon50 btn-icon" title="微信登录" style="margin-right: 16px;">
                                                        <i class="icon">&#xe716;</i>
                                                    </a>
                                                    <a href="#" onclick="location.href='${staticResourcePath}/thirdParty/toTencentLogin.action';" id="qqLoginBtn" class="btn-circle btn-icon50 btn-icon" title="QQ登录" style="margin-right: 16px;">
                                                        <i class="icon">&#xe728;</i>
                                                    </a>
                                                    <#--<%-- 													<a href="#" onclick="javascript:location.href='${staticResourcePath}/thirdParty/toJCloudLogin.action';" id="jCloudLoginBtn" class="btn-circle btn-icon50 btn-icon" title="京东万象"> --%>-->
                                                    <!-- 													   <i class="icon">&#xe6fd;</i> -->
                                                    <!-- 													</a> -->
                                                </div>
                                            ...
                                            <div class="mt20 text-center fc_dark_grey">没有帐号？
                                                <a class="fc_orange-b" href="${staticResourcePath}/login.shtml?login=2" >免费注册</a></div>
                                        </div>
                                        <!--帐号密码登录 end-->
                                    </div>
...
// 	        }
            ...
            $.ajax({
                url : "${staticResourcePath}/identiy/login/userLogin" ,
                type : "post",
                dataType : "json",
                ...
                success : function(data) {
                    if(data.code=="0000"){
                        window.location.href="${staticResourcePath}/hot/events/goHotHome?firstLoginSign="+data.data.firstLoginSign;
                    } else{
                        $("#new_mfzc").html("<span class='errorText'>"+data.msg+"</span>");
                        messageSettime(3);
                        loginFlag = true;
        ...
        function mobileLogin() {
            ...
            $.ajax({
                url : "${staticResourcePath}/indexLogin2.action" ,
                type : "post",
                dataType : "json",
// 	            data: $('#loginFormID').serialize(),
                data:{
                ...
                success : function(data) {
                    if(data.code=="0000"){
                        window.location.href="${staticResourcePath}/hot/events/goHotHome?firstLoginSign="+data.firstLoginSign;
                    }else{
                        getRan();
                        $("#new_mfzc").html("<span class='errorText'>"+data.message+"</span>");
                        messageSettime(3);
                        loginFlag2 = true;
                    }
                }
...
<script type="text/javascript">
    ...
    function goEndActive(){
        window.open("${staticResourcePath}/goActivePay.shtml", "_blank");
    }

    function goSetKeyword(){
        window.location = "${staticResourcePath}/keyword.shtml";
    }

    function goNextRegin(){
        window.location = "${staticResourcePath}/user/events/newGoRegisterPage";
    }

    function goActivePay(){
        var href='${staticResourcePath}/goActivePay.shtml';
        window.open(href,"_blank");
    }
    ...
    function isMobile(){
        ...
        if (bs.versions.mobile) {
            ...
            location.href="${staticResourcePath}/user/goRegister.shtml";
        }
    }
...
<script>
    ...
    <#if admin1??>
            $(function () {
                $.ajax({
                    type: "post",
                    url: actionBase+'/hot/events/selectCoupons',
                    data: {'nearGet': 1,
                        'nearDue': 1,
                        'couponType': 1,
                        'couponUse': 2,
