					...
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading titlBar">
								...
								<div class="tools">
									<a href="javascript:void(0)" class="reload" data-toggle="tooltip" data-placement="top" title="" data-original-title="刷新">
								...
								<div class="panel-body" style="padding: 0;">
									...
									<div class="col-md-3 boright_after">
										<div class="widget-des">
											...
											<p class="fz14 fc666">
												<span class="v_a_m">一小时热度变化趋势</span>
												<span class="v_a_m" rel="drevil" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="该数据表示：当前一小时与上一个小时的热度变化情况">
													<i class="icon fz16 v_a_m">&#xe72a;</i>
												</span>
						...
						<div class="panel panel-default" id="reDuZhiShuQuShi">
							...
							<div class="panel-collapse collapse in" id="collapse2" aria-expanded="true">
								<div class="panel-body">
									...
									<div class="pading20 pading-left-25 pading-right-25 align_c">
<#--<%-- 										<span class="small fc_dark_grey fz20"><i class="icon-square fc-orange fz12"></i> 陈伟霆</span> --%>-->
<%-- 										<span class="small ml30 fc_dark_grey fz20"><i class="icon-square fc_blue fz12"></i> 张艺兴</span> --%>
											
										<div id="reduNameless10">
											<span class="fz16"><i class="legend-icon"></i> <span class="reduNameClass1"></span>热度趋势</span>
											<span class="fz16 ml30"><i class="legend-icon-average"></i> <span class="reduNameClass1"></span>热度均值</span>
											<span class="fz16 ml50"><i class="legend-icon legend-blue"></i> <span class="reduNameClass2"></span>热度趋势</span>
											<span class="fz16 ml30"><i class="legend-icon-average legend-blue"></i> <span class="reduNameClass2"></span>热度均值</span>
										</div>
										<div id="reduNamemore10">
											<div class="inline-block">
												<span class="fz16 block mb15"><i class="legend-icon"></i> <span class="reduNameClass1"></span>热度趋势</span>
												<span class="fz16 block"><i class="legend-icon-average"></i> <span class="reduNameClass1"></span>热度均值</span>
											</div>
											<div class="inline-block ml50">
												<span class="fz16 block mb15"><i class="legend-icon legend-blue"></i> <span class="reduNameClass2"></span>热度趋势</span>
												<span class="fz16 block"><i class="legend-icon-average legend-blue"></i> <span class="reduNameClass2"></span>热度均值</span>
											</div>
										</div>
  ...
  //随机数
    ...
    function worthCallback(data, index){
    	...
    	if(null==data){
            ...
            $("#degreeHeatChart1").html("<div align=\"center\" style=\"padding-top:50px;margin-top: 90px;\"><p style=\"display:inline;font-size: 14px\"><img src=\"${staticResourcePath}/images/shouye/warn.png\"><br/>此时间段暂无信息</p></div>");
            $("#degreeHeatChart2").html("<div align=\"center\" style=\"padding-top:50px;margin-top: 90px;\"><p style=\"display:inline;font-size: 14px\"><img src=\"${staticResourcePath}/images/shouye/warn.png\"><br/>此时间段暂无信息</p></div>");
    	...
    	if(null!=r){
            ...
            if ((data.length==1&&data.jsons == null) || (data.length==1&&data.jsons == "")) {
            	$("#container1").html("<div align=\"center\" style=\"padding-top:50px\"><p style=\"display:inline;font-size: 14px\"><img src=\"${staticResourcePath}/images/shouye/warn.png\"><br/>此时间段暂无信息</p></div>");
                $("#degreeHeatChart"+r).html("<div align=\"center\" style=\"padding-top:50px;margin-top: 90px;\"><p style=\"display:inline;font-size: 14px\"><img src=\"${staticResourcePath}/images/shouye/warn.png\"><br/>此时间段暂无信息</p></div>");
                $(".counter").html("<div align=\"center\" style=\"padding-top:50px\"><p style=\"display:inline;font-size: 14px\"><img src=\"${staticResourcePath}/images/shouye/warn.png\"><br/>此时间段暂无信息</p></div>");
            } else {
                var html="";
                var names=$("#title").val();
...
//             	if(null==da1){
//    					alertMsg2 = "从热度指数的变化趋势来看，<font style='color:#3FAD7E'>";
//             	}else{
...
//             	}
    				...
    				if(null==da1){
    	        		if(r==1){
	   	              		alertMsg2 ='从热度指数的变化趋势来看，<font style="color:#3FAD7E">' + titArr[0] + '</font>的热度在' + dad[0].name + '时达到了<font class="f_c2">' + commafy(dad[0].value) + '</font>的峰值。';
    	        		}else{
	   	              		alertMsg2 ='<font style="color:#3FAD7E">' + titArr[1] + '</font>的热度在' + dad[0].name + '时达到了<font class="f_c2">' + commafy(dad[0].value) + '</font>的峰值。';
    	        		}
                    	//复制出去
                    	da1=data.jsonLine;
                    	da2=data.dates;
                    	...
                    	var hotmsg="";
                    	if(r==1){
                    		hotmsg ='从热度指数的变化趋势来看，<font style="color:#3FAD7E">' + titArr[0] + '</font>的热度在' + dad[0].name + '时达到了<font class="f_c2">' + commafy(dad[0].value) + '</font>的峰值。';
	                        $("#container1_msg").html(hotmsg+alertMsg2);
    	        		}else{
    	        			hotmsg ='<font style="color:#3FAD7E">' + titArr[1] + '</font>的热度在' + dad[0].name + '时达到了<font class="f_c2">' + commafy(dad[0].value) + '</font>的峰值。';
    ...
    function relatedCallBack(data,index){
    	relatedData=data;
	    	...
	    	if(null==data){
	    		...
	    		c21.innerHTML = "<br> <div align=\"center\" style=\"padding-top:50px\"><p style=\"display:inline;font-size: 14px\"><img src=\"${staticResourcePath}/images/shouye/warn.png\" style=\"width:60px\"><br/>此时间段暂无信息</p></div>";
	    		c22.innerHTML = "<br> <div align=\"center\" style=\"padding-top:50px\"><p style=\"display:inline;font-size: 14px\"><img src=\"${staticResourcePath}/images/shouye/warn.png\" style=\"width:60px\"><br/>此时间段暂无信息</p></div>";
	    		return;
	    	}
    	if(null!=index){
    		var r=index;
...
// 		$("#hotMessageName").html(title);
    	...
    	if(keywords.indexOf(",")>=0){
    		...
    		function goHotMessageCallBack(datt,index){
	    		...
	    		if(null==datt){
	    			$("#hotMessageDivId1").html("<div align=\"center\" style=\"padding-top:50px; padding-bottom:150px; \"><p style=\"display:inline;font-size: 14px\"><img src=\"${staticResourcePath}/images/shouye/warn.png\"><br/>此时间段暂无信息</p></div>");
	    			$("#hotMessageDivId2").html("<div align=\"center\" style=\"padding-top:50px; padding-bottom:150px; \"><p style=\"display:inline;font-size: 14px\"><img src=\"${staticResourcePath}/images/shouye/warn.png\"><br/>此时间段暂无信息</p></div>");
	    			return;
	    		}
	    		var data = datt.jsons;
...
// 	    		if(null!=data && null!=data2){
	    			var num=0;
	    			if(null==data && null==data2){
	    				$("#hotMessageDivId"+r).html("<div align=\"center\" style=\"padding-top:50px; padding-bottom:150px; \"><p style=\"display:inline;font-size: 14px\"><img src=\"${staticResourcePath}/images/shouye/warn.png\"><br/>此时间段暂无信息</p></div>");
	    				return;
	    			}
	    			if(null==data && null!=data2){
	    				num = 6;
...
// 		$("#relevantName").html(title);
	...
	function goAssociationCallBack(data,index){
		if(null==data){
			...
			$("#relevantChart1").html("<div align=\"center\" style=\"padding-top:50px; padding-bottom:150px; \"><p style=\"display:inline;font-size: 14px\"><img src=\"${staticResourcePath}/images/shouye/warn.png\"><br/>此时间段暂无信息</p></div>");
			$("#relevantChart2").html("<div align=\"center\" style=\"padding-top:50px; padding-bottom:150px; \"><p style=\"display:inline;font-size: 14px\"><img src=\"${staticResourcePath}/images/shouye/warn.png\"><br/>此时间段暂无信息</p></div>");
			return;
		}
		if(index==1){
		...
		if(null!=index){
    		...
    		if(null!=data){
    			...
    			var htm="通过对<font style='color:#3FAD7E'>"+title+"</font>的相关信息进行分析，与核心词"+da.na+"关联词最高的词语依次为<font class='fc_red'>";
    			if(null!=dx&&dx!=""){
    				for(var i=0;i<dx.length;i++){
    					var s=[];
    					s.push(dx[i].xVal);
...
//     				associationMsg=null;
    			...
    			jquery('#relevantChart'+r).loader('hide',loaders);
    			$("#relevantChart"+r).html("<div align=\"center\" style=\"padding-top:50px; padding-bottom:150px; \"><p style=\"display:inline;font-size: 14px\"><img src=\"${staticResourcePath}/images/shouye/warn.png\"><br/>此时间段暂无信息</p></div>");
    		}
    		}else{
    			jquery('#relevantChart'+r).loader('hide',loaders);
    			$("#relevantChart"+r).html("<div align=\"center\" style=\"padding-top:50px; padding-bottom:150px; \"><p style=\"display:inline;font-size: 14px\"><img src=\"${staticResourcePath}/images/shouye/warn.png\"><br/>此时间段暂无信息</p></div>");
...
function chartloadingReloadSelect(id,flag){
    ...
    if(id=="container1" || id=="degreeHeatChart"|| id=="relevantChart"|| id=="container2"){//container2
    	...
    	smg+='<span class="v_a_m fc_red">相关性：</span> <span class="v_a_m fc_gray">强</span> <i class="icon-dian fz18" style="color: rgba(117,152,222,0.3);"></i><i class="icon-dian fz18" style="color: rgba(117,152,222,0.1);"></i><i class="icon-dian fz18" style="color: rgba(117,152,222,0.07);"></i><span class="v_a_m fc_gray">弱</span>';
    	smg+='</div>';
    	smg+='</div>';
...
//     }
	...
	function beginQuery(){
    	chartloading("container21");//词云 
//     	chartloading("degreeHeatChart1");//热度值
//     	chartloading("relevantChart2");//关联度
    	chartloadingTab("qiamwamgTuan1")
    	chartloading("container22");//词云 
    	chartloading("degreeHeatChart2");//热度值
    	chartloading("relevantChart1");//关联度
